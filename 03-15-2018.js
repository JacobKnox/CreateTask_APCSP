...
function arrayinsert12345(question, array, index, retry){
  if (question == "1" || question == "one" || question == "One"){
    array[index] = 1;
...
/*
    ...
    console.log("We're sorry, but your response does not mach a valid input. Try again!");
    var tryagain = 0;
    while ((tryagain != "a") || (tryagain != "A") || (tryagain != "b") || (tryagain != "B") || (tryagain != "c") || (tryagain != "C") || (tryagain != "d") || (tryagain != "D")){
      tryagain = prompt(retry);
...
Attempting to make a loop that runs until a "valid" input is given
...
// Jeremy helped me realize that this portion was flawed, because it would move to the else result if the score wasn't exactl 1, 2, or 3  
  if (score <= 1){
